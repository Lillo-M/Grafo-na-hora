...
from grafoNaHora.views import DisciplinasPorCursoView, CadastroView, LoginView, DisciplinasConcluidasView, FeedbackCreateView, DeleteUserView, UpdateUserView
